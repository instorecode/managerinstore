...
public class CepService {
    ...
    public static CepResult get(String cep) {
        ...
        try {
            ...
            Annotations.configureAliases(xstream, CepResult.class);
            xstream.alias("webservicecep", CepResult.class);
            CepResult cepServiceVO = (CepResult) xstream.fromXML(newData.toString());
