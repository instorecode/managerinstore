    ...
    <jsp:attribute name="gridColumn">
        <script type="text/javascript">
            var gridColumn = [
                ...
                {title: 'Tipo', name: 'descricao', index: true, filter: true, filterType: 'input'},
                {title: 'Descrição', name: 'tipo', index: true, filter: true, filterType: 'input'},
                {title: 'Percentual', name: 'percentual', index: true, filter: true, filterType: 'input'},
            ];
