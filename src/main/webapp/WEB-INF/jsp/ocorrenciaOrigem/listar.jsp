...
<instore:template isGrid="false">
    <jsp:body> 
        ...
        <c:forEach items="${funcionalidadeBeanList}" var="func">
            <c:if test="${func.mappingId eq '/ocorrencia-origem/cadastrar'}">
                <c:set scope="session" var="form_access" value="${true}"></c:set>
            </c:if>

            <c:if test="${func.mappingId eq '/ocorrencia-origem/atualizar/{id}'}">
                <c:set scope="session" var="update_access" value="${true}"></c:set>
            </c:if>

            <c:if test="${func.mappingId eq '/ocorrencia-origem/remover/{id}'}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ocorrenciaOrigemBean.descricao" class="form-control" placeholder="Descrição"  
        ...
        <div class="edit">
            <c:if test="${update_access}">
                ...
                <form name="FORM_ALTERAR_[[__PK__]]" method="POST" data-formtable="true" action="${url}/ocorrencia-origem/cadastrar">
                    <input type="hidden" name="ocorrenciaOrigemBean.id" value="${ocorrenciaOrigemBean.id}" field="id" />
