...
<instore:template isGrid="false">
    <jsp:body>
        ...
        <c:set scope="session" var="msg_not_permission" value="Acesso não permitdo a essa funcionaliade"></c:set>
        ...
        <c:if test="${countProjetos eq 0}">
            <c:set scope="session" var="form_access" value="${false}"></c:set>
            <c:set scope="session" var="msg_not_permission" value="Não é possível cadastrar uma versão sem existir algum projeto"></c:set>
        </c:if>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="versaoBean.descricao" class="form-control" placeholder="Descrição"  
                                               data-rule-required="true" 
                                               data-rule-minlength="3"
