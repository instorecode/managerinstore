        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                ...
                jQuery('.sel_importe').on('change', function() {
                    ...
                    console.log("${url}/audiostore-musica/loadmusica/"+jQuery('.select_cliente option:selected').val()+"/"+nome_arquivo);
                    ...
                    $("#jquery_jplayer_1").jPlayer({
                        ready: function() {
                            $(this).jPlayer("setMedia", {
                                title: "Musica",
                                mp3: "${url}/audiostore-musica/loadmusica/"+jQuery('.select_cliente option:selected').val()+"/"+nome_arquivo
                            });
                        },
