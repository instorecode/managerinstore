    ...
    <jsp:body> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="projetoBean.descricao" class="form-control" placeholder="Descrição"  
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="projetoBean.linkDocumentacao" class="form-control" placeholder="Link Documentação"  
                                               data-rule-required="true" 
                                               data-rule-minlength="3"
        ...
        <div class="view"> 
            ...
            <ol class="view_itens" type="i">
                ...
                <li>
                    <strong>Link Documentação</strong>
                    <br />
                ...
                <table  id="table" 
                    ...
                    <thead>
                        <tr>
                            ...
                            <th field="linkDocumentacao" options="false">Documentação</th>                            
                        </tr>
                    </thead>
                </table>
            </div>
