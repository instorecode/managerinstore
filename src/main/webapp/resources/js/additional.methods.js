...
jQuery.validator.addMethod("proghora1", function(time, element) {
    var inicio = Date.parse("1970-01-01T00:00:00");
    var fim = Date.parse("1970-01-01T23:59:59");
    
    var time1 = jQuery('[name="horaInicio"]').val();
    var time2 = jQuery('[name="horaFinal"]').val();
    
    if (null != time1 && '' != time1 && null != time2 && '' != time2) {
        var hora1 = Date.parse("1970-01-01T" + time1);
        var hora2 = Date.parse("1970-01-01T" + time2);
    ...
    return true;
}, "O horário inicial deve ser menor que o horario final!");

jQuery.validator.addMethod("proghora2", function(time, element) {
    var inicio = Date.parse("1970-01-01T00:00:00");
    var fim = Date.parse("1970-01-01T23:59:59");
