...
(function () {
    ...
    _.extend(bbGrid.View.prototype, Backbone.View.prototype, {
        ...
        render: function () {
            ...
            if (!this.$navBar) {
                ...
                this.$loading = $('<div class="bbGrid-loading progress progress-info progress-striped active" style="float: left; margin-top: -32px;"><div class="bar bbGrid-loading-progress">' + this.dict.loading + '</div></div>');
    ...
    _.extend(bbGrid.PagerView.prototype, Backbone.View.prototype, {
        ...
        template: _.template(
            '<div class="span bbGrid-pager" style="float: left;">\
                <ul class="nav nav-pills">\
                    <li<%if (page === 1) {%> class="active "<%}%>>\
                        <a class="first">&nbsp;<i class="fa fa-fast-backward" style="color: black;"/>&nbsp;</a>\
                    </li>\
                    <li <%if (page === 1) {%> class="active"<%}%>>\
                        <a class="left">&nbsp;<i class="fa fa-backward" style="color: black;"/>&nbsp;</a>\
                    </li>\
                    <li>\
                        <div class="bbGrid-page-counter pull-left" style="margin-top: 5px;padding-left: 10px;padding-right: 10px;"><%=dict.page%>.</div>\
                        <input class="bbGrid-page-input form-control" value="<%=page%>" type="text">\
                        <div class="bbGrid-page-counter-right pull-right" style="margin-top: 5px;padding-left: 10px;padding-right: 10px;"> <%=dict.prep%> <%=cntpages%> </div>\
                    </li>\
                    <li<%if (page === cntpages) {%> class="active"<%}%>>\
                        <a class="right">&nbsp;<i class="fa fa-forward" style="color: black;"/>&nbsp;</a>\
                    </li>\
                    <li<%if (page === cntpages) {%> class="active"<%}%>>\
                        <a class="last">&nbsp;<i class="fa fa-fast-forward" style="color: black;"/>&nbsp;</a>\
                    </li>\
                </ul>\
                </div>\
            <% if (rowlist) {%>\
